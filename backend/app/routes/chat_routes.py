...
async def chat(request: ChatRequest, user_id: str = Depends(get_current_user)):
    ...
    system_content = (
        ...
        "5. If a user asks about details of a trip (e.g. 'my trip', 'bestie's trip', 'upcoming trip', 'weather for my trip') but does not specify the destination or dates, you MUST call `get_user_trips` first to retrieve the active booking details. DO NOT guess the destination or dates.\n\n"
